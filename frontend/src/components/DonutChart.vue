...
<script lang="ts">
    ...
    export default defineComponent({
        ...
        setup(props) {
            const ionicFontFamily = getComputedStyle(document.documentElement)
                .getPropertyValue("--ion-font-family")
                .trim()
            const primaryContrast = getComputedStyle(document.documentElement)
            ...
            const happinessData = computed(() => {
                ...
                const colors = [
                    getComputedStyle(document.documentElement)
                        .getPropertyValue("--color-very-happy")
                        .trim(),
                    getComputedStyle(document.documentElement)
                    ...
                    getComputedStyle(document.documentElement)
                        ...
                        .trim(),
                    getComputedStyle(document.documentElement)
                        .getPropertyValue("--color-very-sad")
                        .trim(),
                    getComputedStyle(document.documentElement)
                        .getPropertyValue("--color-not-specified")
                        .trim(),
                ]
