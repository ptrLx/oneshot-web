<template>
    <base-layout page-title="Profile" default-back-link="/home">
        ...
        <ion-grid class="ion-text-center">
            ...
            <ion-row>
                <ion-col size="12">
                    <ion-button shape="round" @click="$router.push('/change-password')"
            ...
            <ion-row>
                <ion-col size="12">
                    <ion-button shape="round" @click="openFileDialog('file-upload')"
                        >Import database</ion-button
                    >
                </ion-col>
                <input
                    type="file"
        ...
        <ion-modal trigger="open-modal" :initial-breakpoint="1" :breakpoints="[0, 1]">
            <base-layout pageTitle="Open Source Licence" hide-back-button="true" fullscreen="false">
                <div style="padding: 20px">
                    <p>
                        OneShot-Web is free software released under GPLv3 and comes with absolutely
                        no warranty.
                    </p>
...
<script lang="ts">
    ...
    export default defineComponent({
        ...
        setup() {
            ...
            UserService.getUserMeUserMeGet().then(
                (response) => {
